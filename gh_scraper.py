...
if __name__ == "__main__":
    ...
    parser.add_argument('urls_file', type=str, help="The path of the file containing the GitHub Archive URLs.")
    parser.add_argument('output_folder', type=str, help="The path of the folder where the CSV files will be generated.")
